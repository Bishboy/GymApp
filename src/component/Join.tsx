...
const Join = () => {
  ...
  return (
    <div className="flex gap-[10rem] px-[2rem]">
      <div className="text-white relative text-[3rem] font-bold">
      ...
      <div>
        <form
          ref={formRef}
          className="flex gap-[3rem] bg-gray-400 p-[1rem] px-8 rounded"
          onSubmit={sendEmail}
        >
          <input
            type="email"
          ...
          <button className="btn bg-orange-400 text-white  whitespace-nowrap">
            {loading ? <FiLoader className="animate-spin  " /> : "Join now"}
          </button>
        </form>
      </div>
    </div>
