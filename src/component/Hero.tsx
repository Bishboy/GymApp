  ...
  return (
    <div className="flex flex-col md:flex-row justify-between md:px-[4rem] px-2  gap-2  ">
      ...
      <div className="py-[1rem] flex flex-col gap-[2rem] px-2 md:w-[70%]  items-center md:items-start ">
        <Header />
        <div className="mt-[4rem] bg-[#363d42] relative text-white items-center uppercase rounded-[4rem] w-fit p-4 px-6">
          <motion.div
            className="absolute z-10 bg-[#f48915] w-[4.5rem] h-[80%] left-[8px] top-[6px] rounded-[3rem]"
            initial={{ left: mobile ? "178px" : "238px" }}
            whileInView={{ left: "8px" }}
            transition={{ ...transition, type: "tween" }}
          ></motion.div>
          <span className="z-40 relative text-xs md:text-base">
      ...
      <div className="flex flex-1 relative bg-none md:bg-[#f48915]">
        ...
        <img
          src={hero_image}
          alt=""
          className="md:absolute relative left-[7rem] align-middle  md:top-[10rem] md:right-[8rem] w-[15rem] md:w-[23rem]"
        />
        <motion.img
          ...
          transition={transition}
          alt=""
          className="absolute md:top-[4rem] top-0 left-[2rem] md:right-[20rem] w-[15rem] -z-10"
        />

        <motion.div
          className="md:flex gap-[2rem] h-fit hidden p-[1rem] items-center justify-center px-[4rem] absolute      top-[35rem] w-fit rounded-[5px] bg-[#656565]"
          initial={{ right: "37rem" }}
